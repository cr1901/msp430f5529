...
pub struct R(crate::R<TA0CCTL4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA0CCTL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TA0CCTL4_SPEC>> for R {
    fn from(reader: crate::R<TA0CCTL4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA0CCTL4` writer"]
pub struct W(crate::W<TA0CCTL4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA0CCTL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TA0CCTL4_SPEC>> for W {
    fn from(writer: crate::W<TA0CCTL4_SPEC>) -> Self {
        W(writer)
    }
}
