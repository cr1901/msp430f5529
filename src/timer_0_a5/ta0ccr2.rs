...
pub type R = crate::R<TA0CCR2_SPEC>;
#[doc = "Register `TA0CCR2` writer"]
pub type W = crate::W<TA0CCR2_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<TA0CCR2_SPEC> {
