...
pub type R = crate::R<TA0CCR1_SPEC>;
#[doc = "Register `TA0CCR1` writer"]
pub type W = crate::W<TA0CCR1_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<TA0CCR1_SPEC> {
