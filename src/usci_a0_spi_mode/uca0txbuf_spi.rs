...
pub type R = crate::R<UCA0TXBUF_SPI_SPEC>;
#[doc = "Register `UCA0TXBUF_SPI` writer"]
pub type W = crate::W<UCA0TXBUF_SPI_SPEC>;
...
#[doc = "USCI A0 Transmit Buffer\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uca0txbuf_spi::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uca0txbuf_spi::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
