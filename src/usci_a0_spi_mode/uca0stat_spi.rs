#[doc = "Reader of register UCA0STAT_SPI"]
pub type R = crate::R<u8, super::UCA0STAT_SPI>;
#[doc = "Writer for register UCA0STAT_SPI"]
pub type W = crate::W<u8, super::UCA0STAT_SPI>;
#[doc = "Register UCA0STAT_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA0STAT_SPI {
    type Type = u8;
    #[inline(always)]
