...
pub type R = crate::R<UCA0CTL1_SPI_SPEC>;
#[doc = "Register `UCA0CTL1_SPI` writer"]
pub type W = crate::W<UCA0CTL1_SPI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucswrst(&mut self) -> UCSWRST_W<UCA0CTL1_SPI_SPEC> {
        UCSWRST_W::new(self, 0)
    }
    #[doc = "Bits 6:7 - USCI 1 Clock Source Select 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucssel(&mut self) -> UCSSEL_W<UCA0CTL1_SPI_SPEC> {
        UCSSEL_W::new(self, 6)
    }
...
#[doc = "USCI A0 Control Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uca0ctl1_spi::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uca0ctl1_spi::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
