#[doc = "Register `P4MAP1` reader"]
pub type R = crate::R<P4MAP1_SPEC>;
#[doc = "Register `P4MAP1` writer"]
pub type W = crate::W<P4MAP1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmap0(&mut self) -> PMAP0_W<P4MAP1_SPEC> {
        PMAP0_W::new(self, 0)
    }
    #[doc = "Bit 1 - PMAP1"]
    #[inline(always)]
    #[must_use]
    pub fn pmap1(&mut self) -> PMAP1_W<P4MAP1_SPEC> {
        PMAP1_W::new(self, 1)
    }
    #[doc = "Bit 2 - PMAP2"]
    #[inline(always)]
    #[must_use]
    pub fn pmap2(&mut self) -> PMAP2_W<P4MAP1_SPEC> {
        PMAP2_W::new(self, 2)
    }
    #[doc = "Bit 3 - PMAP3"]
    #[inline(always)]
    #[must_use]
    pub fn pmap3(&mut self) -> PMAP3_W<P4MAP1_SPEC> {
        PMAP3_W::new(self, 3)
    }
    #[doc = "Bit 4 - PMAP4"]
    #[inline(always)]
    #[must_use]
    pub fn pmap4(&mut self) -> PMAP4_W<P4MAP1_SPEC> {
        PMAP4_W::new(self, 4)
    }
    #[doc = "Bit 5 - PMAP5"]
    #[inline(always)]
    #[must_use]
    pub fn pmap5(&mut self) -> PMAP5_W<P4MAP1_SPEC> {
        PMAP5_W::new(self, 5)
    }
    #[doc = "Bit 6 - PMAP6"]
    #[inline(always)]
    #[must_use]
    pub fn pmap6(&mut self) -> PMAP6_W<P4MAP1_SPEC> {
        PMAP6_W::new(self, 6)
    }
    #[doc = "Bit 7 - PMAP7"]
    #[inline(always)]
    #[must_use]
    pub fn pmap7(&mut self) -> PMAP7_W<P4MAP1_SPEC> {
        PMAP7_W::new(self, 7)
    }
...
#[doc = "Port P4.1 mapping register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`p4map1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`p4map1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P4MAP1_SPEC;
impl crate::RegisterSpec for P4MAP1_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`p4map1::R`](R) reader structure"]
impl crate::Readable for P4MAP1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`p4map1::W`](W) writer structure"]
impl crate::Writable for P4MAP1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets P4MAP1 to value 0"]
impl crate::Resettable for P4MAP1_SPEC {
