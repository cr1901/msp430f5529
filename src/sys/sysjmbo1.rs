...
pub type R = crate::R<SYSJMBO1_SPEC>;
#[doc = "Register `SYSJMBO1` writer"]
pub type W = crate::W<SYSJMBO1_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<SYSJMBO1_SPEC> {
