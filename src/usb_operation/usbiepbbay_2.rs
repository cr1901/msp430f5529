...
pub struct R(crate::R<USBIEPBBAY_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBIEPBBAY_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<USBIEPBBAY_2_SPEC>> for R {
    fn from(reader: crate::R<USBIEPBBAY_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBIEPBBAY_2` writer"]
pub struct W(crate::W<USBIEPBBAY_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBIEPBBAY_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<USBIEPBBAY_2_SPEC>> for W {
    fn from(writer: crate::W<USBIEPBBAY_2_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
