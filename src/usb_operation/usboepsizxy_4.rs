...
pub type R = crate::R<USBOEPSIZXY_4_SPEC>;
#[doc = "Register `USBOEPSIZXY_4` writer"]
pub type W = crate::W<USBOEPSIZXY_4_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<USBOEPSIZXY_4_SPEC> {
