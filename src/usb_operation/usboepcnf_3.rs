#[doc = "Register `USBOEPCNF_3` reader"]
pub type R = crate::R<USBOEPCNF_3_SPEC>;
#[doc = "Register `USBOEPCNF_3` writer"]
pub type W = crate::W<USBOEPCNF_3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbiie(&mut self) -> USBIIE_W<USBOEPCNF_3_SPEC> {
        USBIIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - USB - Stall Condition"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<USBOEPCNF_3_SPEC> {
        STALL_W::new(self, 3)
    }
    #[doc = "Bit 4 - USB - Double Buffer Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbuf(&mut self) -> DBUF_W<USBOEPCNF_3_SPEC> {
        DBUF_W::new(self, 4)
    }
    #[doc = "Bit 5 - USB - Toggle Bit"]
    #[inline(always)]
    #[must_use]
    pub fn toggle(&mut self) -> TOGGLE_W<USBOEPCNF_3_SPEC> {
        TOGGLE_W::new(self, 5)
    }
    #[doc = "Bit 7 - USB - UBM In-Endpoint Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ubme(&mut self) -> UBME_W<USBOEPCNF_3_SPEC> {
        UBME_W::new(self, 7)
    }
...
#[doc = "Output Endpoint_3: Configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usboepcnf_3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usboepcnf_3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USBOEPCNF_3_SPEC;
impl crate::RegisterSpec for USBOEPCNF_3_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`usboepcnf_3::R`](R) reader structure"]
impl crate::Readable for USBOEPCNF_3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usboepcnf_3::W`](W) writer structure"]
impl crate::Writable for USBOEPCNF_3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USBOEPCNF_3 to value 0"]
impl crate::Resettable for USBOEPCNF_3_SPEC {
