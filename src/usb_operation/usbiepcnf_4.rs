#[doc = "Register `USBIEPCNF_4` reader"]
pub type R = crate::R<USBIEPCNF_4_SPEC>;
#[doc = "Register `USBIEPCNF_4` writer"]
pub type W = crate::W<USBIEPCNF_4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbiie(&mut self) -> USBIIE_W<USBIEPCNF_4_SPEC> {
        USBIIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - USB - Stall Condition"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<USBIEPCNF_4_SPEC> {
        STALL_W::new(self, 3)
    }
    #[doc = "Bit 4 - USB - Double Buffer Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dbuf(&mut self) -> DBUF_W<USBIEPCNF_4_SPEC> {
        DBUF_W::new(self, 4)
    }
    #[doc = "Bit 5 - USB - Toggle Bit"]
    #[inline(always)]
    #[must_use]
    pub fn toggle(&mut self) -> TOGGLE_W<USBIEPCNF_4_SPEC> {
        TOGGLE_W::new(self, 5)
    }
    #[doc = "Bit 7 - USB - UBM In-Endpoint Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ubme(&mut self) -> UBME_W<USBIEPCNF_4_SPEC> {
        UBME_W::new(self, 7)
    }
...
#[doc = "Input Endpoint_4: Configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usbiepcnf_4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usbiepcnf_4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USBIEPCNF_4_SPEC;
impl crate::RegisterSpec for USBIEPCNF_4_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`usbiepcnf_4::R`](R) reader structure"]
impl crate::Readable for USBIEPCNF_4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usbiepcnf_4::W`](W) writer structure"]
impl crate::Writable for USBIEPCNF_4_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USBIEPCNF_4 to value 0"]
impl crate::Resettable for USBIEPCNF_4_SPEC {
