#[doc = "Reader of register USBIEPCNF_3"]
pub type R = crate::R<u8, super::USBIEPCNF_3>;
#[doc = "Writer for register USBIEPCNF_3"]
pub type W = crate::W<u8, super::USBIEPCNF_3>;
#[doc = "Register USBIEPCNF_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::USBIEPCNF_3 {
    type Type = u8;
    #[inline(always)]
