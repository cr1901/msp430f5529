...
pub struct R(crate::R<USBOEPBBAX_5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBOEPBBAX_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<USBOEPBBAX_5_SPEC>> for R {
    fn from(reader: crate::R<USBOEPBBAX_5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBOEPBBAX_5` writer"]
pub struct W(crate::W<USBOEPBBAX_5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBOEPBBAX_5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<USBOEPBBAX_5_SPEC>> for W {
    fn from(writer: crate::W<USBOEPBBAX_5_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
