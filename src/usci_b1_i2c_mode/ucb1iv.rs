...
pub type R = crate::R<UCB1IV_SPEC>;
#[doc = "Register `UCB1IV` writer"]
pub type W = crate::W<UCB1IV_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<UCB1IV_SPEC> {
