...
pub type R = crate::R<UCB1IFG_SPEC>;
#[doc = "Register `UCB1IFG` writer"]
pub type W = crate::W<UCB1IFG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg(&mut self) -> UCRXIFG_W<UCB1IFG_SPEC> {
        UCRXIFG_W::new(self, 0)
    }
    #[doc = "Bit 1 - USCI Transmit Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg(&mut self) -> UCTXIFG_W<UCB1IFG_SPEC> {
        UCTXIFG_W::new(self, 1)
    }
    #[doc = "Bit 2 - START Condition interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucsttifg(&mut self) -> UCSTTIFG_W<UCB1IFG_SPEC> {
        UCSTTIFG_W::new(self, 2)
    }
    #[doc = "Bit 3 - STOP Condition interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucstpifg(&mut self) -> UCSTPIFG_W<UCB1IFG_SPEC> {
        UCSTPIFG_W::new(self, 3)
    }
    #[doc = "Bit 4 - Arbitration Lost interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucalifg(&mut self) -> UCALIFG_W<UCB1IFG_SPEC> {
        UCALIFG_W::new(self, 4)
    }
    #[doc = "Bit 5 - NAK Condition interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucnackifg(&mut self) -> UCNACKIFG_W<UCB1IFG_SPEC> {
...
#[doc = "USCI B1 Interrupt Flags Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ucb1ifg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ucb1ifg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
