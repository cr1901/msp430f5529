...
pub type R = crate::R<UCB1IE_SPEC>;
#[doc = "Register `UCB1IE` writer"]
pub type W = crate::W<UCB1IE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucrxie(&mut self) -> UCRXIE_W<UCB1IE_SPEC> {
        UCRXIE_W::new(self, 0)
    }
    #[doc = "Bit 1 - USCI Transmit Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie(&mut self) -> UCTXIE_W<UCB1IE_SPEC> {
        UCTXIE_W::new(self, 1)
    }
    #[doc = "Bit 2 - START Condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucsttie(&mut self) -> UCSTTIE_W<UCB1IE_SPEC> {
        UCSTTIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - STOP Condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucstpie(&mut self) -> UCSTPIE_W<UCB1IE_SPEC> {
        UCSTPIE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Arbitration Lost interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucalie(&mut self) -> UCALIE_W<UCB1IE_SPEC> {
        UCALIE_W::new(self, 4)
    }
    #[doc = "Bit 5 - NACK Condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucnackie(&mut self) -> UCNACKIE_W<UCB1IE_SPEC> {
...
#[doc = "USCI B1 Interrupt Enable Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ucb1ie::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ucb1ie::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
