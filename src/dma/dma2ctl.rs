...
pub type R = crate::R<DMA2CTL_SPEC>;
#[doc = "Register `DMA2CTL` writer"]
pub type W = crate::W<DMA2CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmareq(&mut self) -> DMAREQ_W<DMA2CTL_SPEC> {
        DMAREQ_W::new(self, 0)
    }
    #[doc = "Bit 1 - DMA transfer aborted by NMI"]
    #[inline(always)]
    #[must_use]
    pub fn dmaabort(&mut self) -> DMAABORT_W<DMA2CTL_SPEC> {
        DMAABORT_W::new(self, 1)
    }
    #[doc = "Bit 2 - DMA interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaie(&mut self) -> DMAIE_W<DMA2CTL_SPEC> {
        DMAIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - DMA interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmaifg(&mut self) -> DMAIFG_W<DMA2CTL_SPEC> {
        DMAIFG_W::new(self, 3)
    }
    #[doc = "Bit 4 - DMA enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DMAEN_W<DMA2CTL_SPEC> {
        DMAEN_W::new(self, 4)
    }
    #[doc = "Bit 5 - DMA level sensitive trigger select"]
    #[inline(always)]
    #[must_use]
    pub fn dmalevel(&mut self) -> DMALEVEL_W<DMA2CTL_SPEC> {
        DMALEVEL_W::new(self, 5)
    }
    #[doc = "Bit 6 - DMA source byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcbyte(&mut self) -> DMASRCBYTE_W<DMA2CTL_SPEC> {
        DMASRCBYTE_W::new(self, 6)
    }
    #[doc = "Bit 7 - DMA destination byte"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstbyte(&mut self) -> DMADSTBYTE_W<DMA2CTL_SPEC> {
        DMADSTBYTE_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - DMA source increment bit 0"]
    #[inline(always)]
    #[must_use]
    pub fn dmasrcincr(&mut self) -> DMASRCINCR_W<DMA2CTL_SPEC> {
        DMASRCINCR_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - DMA destination increment bit 0"]
    #[inline(always)]
    #[must_use]
    pub fn dmadstincr(&mut self) -> DMADSTINCR_W<DMA2CTL_SPEC> {
        DMADSTINCR_W::new(self, 10)
    }
    #[doc = "Bits 12:14 - DMA transfer mode bit 0"]
    #[inline(always)]
    #[must_use]
    pub fn dmadt(&mut self) -> DMADT_W<DMA2CTL_SPEC> {
        DMADT_W::new(self, 12)
    }
...
#[doc = "DMA Channel 2 Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dma2ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma2ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
