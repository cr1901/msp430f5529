...
pub type R = crate::R<TA1CCTL0_SPEC>;
#[doc = "Register `TA1CCTL0` writer"]
pub type W = crate::W<TA1CCTL0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccifg(&mut self) -> CCIFG_W<TA1CCTL0_SPEC> {
        CCIFG_W::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    #[must_use]
    pub fn cov(&mut self) -> COV_W<TA1CCTL0_SPEC> {
        COV_W::new(self, 1)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OUT_W<TA1CCTL0_SPEC> {
        OUT_W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn cci(&mut self) -> CCI_W<TA1CCTL0_SPEC> {
        CCI_W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ccie(&mut self) -> CCIE_W<TA1CCTL0_SPEC> {
        CCIE_W::new(self, 4)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    #[must_use]
    pub fn outmod(&mut self) -> OUTMOD_W<TA1CCTL0_SPEC> {
        OUTMOD_W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    #[must_use]
    pub fn cap(&mut self) -> CAP_W<TA1CCTL0_SPEC> {
        CAP_W::new(self, 8)
    }
    #[doc = "Bit 10 - Latched capture signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn scci(&mut self) -> SCCI_W<TA1CCTL0_SPEC> {
        SCCI_W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    #[must_use]
    pub fn scs(&mut self) -> SCS_W<TA1CCTL0_SPEC> {
        SCS_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    #[must_use]
    pub fn ccis(&mut self) -> CCIS_W<TA1CCTL0_SPEC> {
        CCIS_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CM_W<TA1CCTL0_SPEC> {
        CM_W::new(self, 14)
    }
...
#[doc = "Timer1_A3 Capture/Compare Control 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ta1cctl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ta1cctl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
