...
pub type R = crate::R<TA1EX0_SPEC>;
#[doc = "Register `TA1EX0` writer"]
pub type W = crate::W<TA1EX0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn taidex(&mut self) -> TAIDEX_W<TA1EX0_SPEC> {
        TAIDEX_W::new(self, 0)
    }
