...
pub type R = crate::R<TA2CTL_SPEC>;
#[doc = "Register `TA2CTL` writer"]
pub type W = crate::W<TA2CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn taifg(&mut self) -> TAIFG_W<TA2CTL_SPEC> {
        TAIFG_W::new(self, 0)
    }
    #[doc = "Bit 1 - Timer A counter interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn taie(&mut self) -> TAIE_W<TA2CTL_SPEC> {
        TAIE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Timer A counter clear"]
    #[inline(always)]
    #[must_use]
    pub fn taclr(&mut self) -> TACLR_W<TA2CTL_SPEC> {
        TACLR_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Timer A mode control 1"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> MC_W<TA2CTL_SPEC> {
        MC_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Timer A clock input divider 1"]
    #[inline(always)]
    #[must_use]
    pub fn id(&mut self) -> ID_W<TA2CTL_SPEC> {
        ID_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Timer A clock source select 1"]
    #[inline(always)]
    #[must_use]
    pub fn tassel(&mut self) -> TASSEL_W<TA2CTL_SPEC> {
        TASSEL_W::new(self, 8)
    }
...
#[doc = "Timer2_A3 Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ta2ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ta2ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
