...
pub type R = crate::R<USBOEPCNF_0_SPEC>;
#[doc = "Register `USBOEPCNF_0` writer"]
pub type W = crate::W<USBOEPCNF_0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbiie(&mut self) -> USBIIE_W<USBOEPCNF_0_SPEC> {
        USBIIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - USB - Stall Condition"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<USBOEPCNF_0_SPEC> {
        STALL_W::new(self, 3)
    }
    #[doc = "Bit 5 - USB - Toggle Bit"]
    #[inline(always)]
    #[must_use]
    pub fn toggle(&mut self) -> TOGGLE_W<USBOEPCNF_0_SPEC> {
        TOGGLE_W::new(self, 5)
    }
    #[doc = "Bit 7 - USB - UBM In-Endpoint Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ubme(&mut self) -> UBME_W<USBOEPCNF_0_SPEC> {
        UBME_W::new(self, 7)
    }
