...
pub struct R(crate::R<USBIEPCNF_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USBIEPCNF_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<USBIEPCNF_0_SPEC>> for R {
    fn from(reader: crate::R<USBIEPCNF_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USBIEPCNF_0` writer"]
pub struct W(crate::W<USBIEPCNF_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USBIEPCNF_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<USBIEPCNF_0_SPEC>> for W {
    fn from(writer: crate::W<USBIEPCNF_0_SPEC>) -> Self {
        W(writer)
    }
}
