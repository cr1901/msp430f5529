#[doc = "Reader of register UCA1STAT"]
pub type R = crate::R<u8, super::UCA1STAT>;
#[doc = "Writer for register UCA1STAT"]
pub type W = crate::W<u8, super::UCA1STAT>;
#[doc = "Register UCA1STAT `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA1STAT {
    type Type = u8;
    #[inline(always)]
