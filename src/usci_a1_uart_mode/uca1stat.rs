...
pub type R = crate::R<UCA1STAT_SPEC>;
#[doc = "Register `UCA1STAT` writer"]
pub type W = crate::W<UCA1STAT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucbusy(&mut self) -> UCBUSY_W<UCA1STAT_SPEC> {
        UCBUSY_W::new(self, 0)
    }
    #[doc = "Bit 1 - USCI Address received Flag"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucrxerr(&mut self) -> UCRXERR_W<UCA1STAT_SPEC> {
        UCRXERR_W::new(self, 2)
    }
    #[doc = "Bit 3 - USCI Break received"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrk(&mut self) -> UCBRK_W<UCA1STAT_SPEC> {
        UCBRK_W::new(self, 3)
    }
    #[doc = "Bit 4 - USCI Parity Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucpe(&mut self) -> UCPE_W<UCA1STAT_SPEC> {
        UCPE_W::new(self, 4)
    }
    #[doc = "Bit 5 - USCI Overrun Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucoe(&mut self) -> UCOE_W<UCA1STAT_SPEC> {
        UCOE_W::new(self, 5)
    }
    #[doc = "Bit 6 - USCI Frame Error Flag"]
    #[inline(always)]
    #[must_use]
    pub fn ucfe(&mut self) -> UCFE_W<UCA1STAT_SPEC> {
        UCFE_W::new(self, 6)
    }
    #[doc = "Bit 7 - USCI Listen mode"]
    #[inline(always)]
    #[must_use]
    pub fn uclisten(&mut self) -> UCLISTEN_W<UCA1STAT_SPEC> {
...
#[doc = "USCI A1 Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uca1stat::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uca1stat::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
