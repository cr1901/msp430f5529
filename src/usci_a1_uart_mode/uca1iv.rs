...
pub type R = crate::R<UCA1IV_SPEC>;
#[doc = "Register `UCA1IV` writer"]
pub type W = crate::W<UCA1IV_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<UCA1IV_SPEC> {
