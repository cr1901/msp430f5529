#[doc = "Reader of register UCA1MCTL"]
pub type R = crate::R<u8, super::UCA1MCTL>;
#[doc = "Writer for register UCA1MCTL"]
pub type W = crate::W<u8, super::UCA1MCTL>;
#[doc = "Register UCA1MCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA1MCTL {
    type Type = u8;
    #[inline(always)]
