...
pub type R = crate::R<TB0CCTL6_SPEC>;
#[doc = "Register `TB0CCTL6` writer"]
pub type W = crate::W<TB0CCTL6_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccifg(&mut self) -> CCIFG_W<TB0CCTL6_SPEC> {
        CCIFG_W::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    #[must_use]
    pub fn cov(&mut self) -> COV_W<TB0CCTL6_SPEC> {
        COV_W::new(self, 1)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OUT_W<TB0CCTL6_SPEC> {
        OUT_W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn cci(&mut self) -> CCI_W<TB0CCTL6_SPEC> {
        CCI_W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ccie(&mut self) -> CCIE_W<TB0CCTL6_SPEC> {
        CCIE_W::new(self, 4)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    #[must_use]
    pub fn outmod(&mut self) -> OUTMOD_W<TB0CCTL6_SPEC> {
        OUTMOD_W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    #[must_use]
    pub fn cap(&mut self) -> CAP_W<TB0CCTL6_SPEC> {
        CAP_W::new(self, 8)
    }
    #[doc = "Bits 9:10 - Compare latch load source 1"]
    #[inline(always)]
    #[must_use]
    pub fn clld(&mut self) -> CLLD_W<TB0CCTL6_SPEC> {
        CLLD_W::new(self, 9)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    #[must_use]
    pub fn scs(&mut self) -> SCS_W<TB0CCTL6_SPEC> {
        SCS_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    #[must_use]
    pub fn ccis(&mut self) -> CCIS_W<TB0CCTL6_SPEC> {
        CCIS_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CM_W<TB0CCTL6_SPEC> {
        CM_W::new(self, 14)
    }
