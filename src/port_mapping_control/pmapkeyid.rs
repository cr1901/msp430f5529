...
pub struct R(crate::R<PMAPKEYID_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PMAPKEYID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PMAPKEYID_SPEC>> for R {
    fn from(reader: crate::R<PMAPKEYID_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PMAPKEYID` writer"]
pub struct W(crate::W<PMAPKEYID_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PMAPKEYID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PMAPKEYID_SPEC>> for W {
    fn from(writer: crate::W<PMAPKEYID_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
