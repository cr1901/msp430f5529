#[doc = "Reader of register UCA1STAT_SPI"]
pub type R = crate::R<u8, super::UCA1STAT_SPI>;
#[doc = "Writer for register UCA1STAT_SPI"]
pub type W = crate::W<u8, super::UCA1STAT_SPI>;
#[doc = "Register UCA1STAT_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCA1STAT_SPI {
    type Type = u8;
    #[inline(always)]
