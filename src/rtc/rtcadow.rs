#[doc = "Reader of register RTCADOW"]
pub type R = crate::R<u8, super::RTCADOW>;
#[doc = "Writer for register RTCADOW"]
pub type W = crate::W<u8, super::RTCADOW>;
#[doc = "Register RTCADOW `reset()`'s with value 0"]
impl crate::ResetValue for super::RTCADOW {
    type Type = u8;
    #[inline(always)]
