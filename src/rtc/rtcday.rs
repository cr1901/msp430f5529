#[doc = "Reader of register RTCDAY"]
pub type R = crate::R<u8, super::RTCDAY>;
#[doc = "Writer for register RTCDAY"]
pub type W = crate::W<u8, super::RTCDAY>;
#[doc = "Register RTCDAY `reset()`'s with value 0"]
impl crate::ResetValue for super::RTCDAY {
    type Type = u8;
    #[inline(always)]
