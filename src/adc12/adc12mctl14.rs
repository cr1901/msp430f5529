...
pub type R = crate::R<ADC12MCTL14_SPEC>;
#[doc = "Register `ADC12MCTL14` writer"]
pub type W = crate::W<ADC12MCTL14_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc12inch(&mut self) -> ADC12INCH_W<ADC12MCTL14_SPEC> {
        ADC12INCH_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - ADC12 Select Reference Bit 0"]
    #[inline(always)]
    #[must_use]
    pub fn adc12sref(&mut self) -> ADC12SREF_W<ADC12MCTL14_SPEC> {
        ADC12SREF_W::new(self, 4)
    }
    #[doc = "Bit 7 - ADC12 End of Sequence"]
    #[inline(always)]
    #[must_use]
    pub fn adc12eos(&mut self) -> ADC12EOS_W<ADC12MCTL14_SPEC> {
