...
pub type R = crate::R<UCB1CTL0_SPI_SPEC>;
#[doc = "Register `UCB1CTL0_SPI` writer"]
pub type W = crate::W<UCB1CTL0_SPI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucsync(&mut self) -> UCSYNC_W<UCB1CTL0_SPI_SPEC> {
        UCSYNC_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - Sync. Mode: USCI Mode 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucmode(&mut self) -> UCMODE_W<UCB1CTL0_SPI_SPEC> {
        UCMODE_W::new(self, 1)
    }
    #[doc = "Bit 3 - Sync. Mode: Master Select"]
    #[inline(always)]
    #[must_use]
    pub fn ucmst(&mut self) -> UCMST_W<UCB1CTL0_SPI_SPEC> {
        UCMST_W::new(self, 3)
    }
    #[doc = "Bit 4 - Sync. Mode: Data Bits 0:8-bits / 1:7-bits"]
    #[inline(always)]
    #[must_use]
    pub fn uc7bit(&mut self) -> UC7BIT_W<UCB1CTL0_SPI_SPEC> {
        UC7BIT_W::new(self, 4)
    }
    #[doc = "Bit 5 - Sync. Mode: MSB first 0:LSB / 1:MSB"]
    #[inline(always)]
    #[must_use]
    pub fn ucmsb(&mut self) -> UCMSB_W<UCB1CTL0_SPI_SPEC> {
        UCMSB_W::new(self, 5)
    }
    #[doc = "Bit 6 - Sync. Mode: Clock Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ucckpl(&mut self) -> UCCKPL_W<UCB1CTL0_SPI_SPEC> {
        UCCKPL_W::new(self, 6)
    }
    #[doc = "Bit 7 - Sync. Mode: Clock Phase"]
    #[inline(always)]
    #[must_use]
    pub fn ucckph(&mut self) -> UCCKPH_W<UCB1CTL0_SPI_SPEC> {
        UCCKPH_W::new(self, 7)
    }
