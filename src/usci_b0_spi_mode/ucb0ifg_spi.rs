...
pub type R = crate::R<UCB0IFG_SPI_SPEC>;
#[doc = "Register `UCB0IFG_SPI` writer"]
pub type W = crate::W<UCB0IFG_SPI_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucrxifg(&mut self) -> UCRXIFG_W<UCB0IFG_SPI_SPEC> {
        UCRXIFG_W::new(self, 0)
    }
    #[doc = "Bit 1 - USCI Transmit Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn uctxifg(&mut self) -> UCTXIFG_W<UCB0IFG_SPI_SPEC> {
