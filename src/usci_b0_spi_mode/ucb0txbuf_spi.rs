...
pub type R = crate::R<UCB0TXBUF_SPI_SPEC>;
#[doc = "Register `UCB0TXBUF_SPI` writer"]
pub type W = crate::W<UCB0TXBUF_SPI_SPEC>;
...
#[doc = "USCI B0 Transmit Buffer\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ucb0txbuf_spi::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ucb0txbuf_spi::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
