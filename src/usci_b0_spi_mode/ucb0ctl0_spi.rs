#[doc = "Reader of register UCB0CTL0_SPI"]
pub type R = crate::R<u8, super::UCB0CTL0_SPI>;
#[doc = "Writer for register UCB0CTL0_SPI"]
pub type W = crate::W<u8, super::UCB0CTL0_SPI>;
#[doc = "Register UCB0CTL0_SPI `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB0CTL0_SPI {
    type Type = u8;
    #[inline(always)]
