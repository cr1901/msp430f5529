...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucsttie(&mut self) -> UCSTTIE_W<UCB0IE_SPI_SPEC> {
        UCSTTIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - STOP Condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucstpie(&mut self) -> UCSTPIE_W<UCB0IE_SPI_SPEC> {
        UCSTPIE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Arbitration Lost interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucalie(&mut self) -> UCALIE_W<UCB0IE_SPI_SPEC> {
        UCALIE_W::new(self, 4)
    }
    #[doc = "Bit 5 - NACK Condition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ucnackie(&mut self) -> UCNACKIE_W<UCB0IE_SPI_SPEC> {
