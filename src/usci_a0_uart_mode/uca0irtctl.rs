...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl0(&mut self) -> UCIRTXPL0_W<UCA0IRTCTL_SPEC> {
        UCIRTXPL0_W::new(self, 2)
    }
    #[doc = "Bit 3 - IRDA Transmit Pulse Length 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl1(&mut self) -> UCIRTXPL1_W<UCA0IRTCTL_SPEC> {
        UCIRTXPL1_W::new(self, 3)
    }
    #[doc = "Bit 4 - IRDA Transmit Pulse Length 2"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl2(&mut self) -> UCIRTXPL2_W<UCA0IRTCTL_SPEC> {
        UCIRTXPL2_W::new(self, 4)
    }
    #[doc = "Bit 5 - IRDA Transmit Pulse Length 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl3(&mut self) -> UCIRTXPL3_W<UCA0IRTCTL_SPEC> {
        UCIRTXPL3_W::new(self, 5)
    }
    #[doc = "Bit 6 - IRDA Transmit Pulse Length 4"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl4(&mut self) -> UCIRTXPL4_W<UCA0IRTCTL_SPEC> {
        UCIRTXPL4_W::new(self, 6)
    }
    #[doc = "Bit 7 - IRDA Transmit Pulse Length 5"]
    #[inline(always)]
    #[must_use]
    pub fn ucirtxpl5(&mut self) -> UCIRTXPL5_W<UCA0IRTCTL_SPEC> {
