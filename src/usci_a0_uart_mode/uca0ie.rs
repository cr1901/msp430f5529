...
pub type R = crate::R<UCA0IE_SPEC>;
#[doc = "Register `UCA0IE` writer"]
pub type W = crate::W<UCA0IE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucrxie(&mut self) -> UCRXIE_W<UCA0IE_SPEC> {
        UCRXIE_W::new(self, 0)
    }
    #[doc = "Bit 1 - USCI Transmit Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn uctxie(&mut self) -> UCTXIE_W<UCA0IE_SPEC> {
        UCTXIE_W::new(self, 1)
    }
