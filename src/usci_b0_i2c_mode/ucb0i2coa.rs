...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucoa0(&mut self) -> UCOA0_W<UCB0I2COA_SPEC> {
        UCOA0_W::new(self, 0)
    }
    #[doc = "Bit 1 - I2C Own Address 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa1(&mut self) -> UCOA1_W<UCB0I2COA_SPEC> {
        UCOA1_W::new(self, 1)
    }
    #[doc = "Bit 2 - I2C Own Address 2"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa2(&mut self) -> UCOA2_W<UCB0I2COA_SPEC> {
        UCOA2_W::new(self, 2)
    }
    #[doc = "Bit 3 - I2C Own Address 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa3(&mut self) -> UCOA3_W<UCB0I2COA_SPEC> {
        UCOA3_W::new(self, 3)
    }
    #[doc = "Bit 4 - I2C Own Address 4"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa4(&mut self) -> UCOA4_W<UCB0I2COA_SPEC> {
        UCOA4_W::new(self, 4)
    }
    #[doc = "Bit 5 - I2C Own Address 5"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa5(&mut self) -> UCOA5_W<UCB0I2COA_SPEC> {
        UCOA5_W::new(self, 5)
    }
    #[doc = "Bit 6 - I2C Own Address 6"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa6(&mut self) -> UCOA6_W<UCB0I2COA_SPEC> {
        UCOA6_W::new(self, 6)
    }
    #[doc = "Bit 7 - I2C Own Address 7"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa7(&mut self) -> UCOA7_W<UCB0I2COA_SPEC> {
        UCOA7_W::new(self, 7)
    }
    #[doc = "Bit 8 - I2C Own Address 8"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa8(&mut self) -> UCOA8_W<UCB0I2COA_SPEC> {
        UCOA8_W::new(self, 8)
    }
    #[doc = "Bit 9 - I2C Own Address 9"]
    #[inline(always)]
    #[must_use]
    pub fn ucoa9(&mut self) -> UCOA9_W<UCB0I2COA_SPEC> {
        UCOA9_W::new(self, 9)
    }
    #[doc = "Bit 15 - I2C General Call enable"]
    #[inline(always)]
...
#[doc = "USCI B0 I2C Own Address\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ucb0i2coa::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ucb0i2coa::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
