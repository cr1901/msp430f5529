...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucsa0(&mut self) -> UCSA0_W<UCB0I2CSA_SPEC> {
        UCSA0_W::new(self, 0)
    }
    #[doc = "Bit 1 - I2C Slave Address 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa1(&mut self) -> UCSA1_W<UCB0I2CSA_SPEC> {
        UCSA1_W::new(self, 1)
    }
    #[doc = "Bit 2 - I2C Slave Address 2"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa2(&mut self) -> UCSA2_W<UCB0I2CSA_SPEC> {
        UCSA2_W::new(self, 2)
    }
    #[doc = "Bit 3 - I2C Slave Address 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa3(&mut self) -> UCSA3_W<UCB0I2CSA_SPEC> {
        UCSA3_W::new(self, 3)
    }
    #[doc = "Bit 4 - I2C Slave Address 4"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa4(&mut self) -> UCSA4_W<UCB0I2CSA_SPEC> {
        UCSA4_W::new(self, 4)
    }
    #[doc = "Bit 5 - I2C Slave Address 5"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa5(&mut self) -> UCSA5_W<UCB0I2CSA_SPEC> {
        UCSA5_W::new(self, 5)
    }
    #[doc = "Bit 6 - I2C Slave Address 6"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa6(&mut self) -> UCSA6_W<UCB0I2CSA_SPEC> {
        UCSA6_W::new(self, 6)
    }
    #[doc = "Bit 7 - I2C Slave Address 7"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa7(&mut self) -> UCSA7_W<UCB0I2CSA_SPEC> {
        UCSA7_W::new(self, 7)
    }
    #[doc = "Bit 8 - I2C Slave Address 8"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa8(&mut self) -> UCSA8_W<UCB0I2CSA_SPEC> {
        UCSA8_W::new(self, 8)
    }
    #[doc = "Bit 9 - I2C Slave Address 9"]
    #[inline(always)]
    #[must_use]
    pub fn ucsa9(&mut self) -> UCSA9_W<UCB0I2CSA_SPEC> {
        UCSA9_W::new(self, 9)
    }
...
#[doc = "USCI B0 I2C Slave Address\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ucb0i2csa::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ucb0i2csa::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
